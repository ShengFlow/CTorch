...
//                             Bitwise Operations                             //
/* ************************************************************************** */
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_int<TypeOf<T>>)>
...
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_int<TypeOf<T>>)>
TLV_INLINE V bit_blend(V a, V m, V b) {
  #ifdef HAS_AVX512F
...
#if VEC_WIDTH >= 512
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_int<TypeOf<T>>)>
TLV_INLINE V bit_and(V a, V b) {
...
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_int<TypeOf<T>> && is_none<TypeOf<T>, int32_t, uint32_t, int64_t, uint64_t>)>
TLV_INLINE V bit_and(V a, V b, Mask<T> m) {
...
//                              Bit shift left                                //
/* ************************************************************************** */
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int8_t, uint8_t>)>
TLV_INLINE V bit_shl(V v) {
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_slli_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int32_t, uint32_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_slli_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int64_t, uint64_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
TLV_INLINE V bit_shl(V v, int shift) {
...
#if VEC_WIDTH >= 256
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int8_t, uint8_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_slli_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int32_t, uint32_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_slli_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int64_t, uint64_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
#if VEC_WIDTH >= 512
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int8_t, uint8_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_slli_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int32_t, uint32_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_slli_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int64_t, uint64_t>)>
TLV_INLINE V bit_shl(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
#ifdef HAS_AVX512DQ
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_any<TypeOf<T>, int8_t, uint8_t, int16_t, uint16_t>)>
TLV_INLINE V bit_shl(V v, Mask<T> m) {
  return word::blend(v, m, word::bit_shl<Shift>(v));
}
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_any<TypeOf<T>, int8_t, uint8_t, int16_t, uint16_t>)>
TLV_INLINE V bit_shl(V v, int shift, Mask<T> m) {
...
#else // HAS_AVX512DQ
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_int<TypeOf<T>>)>
TLV_INLINE V bit_shl(V v, Mask<T> m) {
  return word::blend(v, m, word::bit_shl<Shift>(v));
}
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_int<TypeOf<T>>)>
...
//                              Bit shift right                               //
/* ************************************************************************** */
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, uint8_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  static const __m128i mask = _mm_set1_epi8(tailing_mask(int32_t(8 - Shift)));
  auto u = _mm_srli_epi16(v.v, Shift);
  return _mm_and_si128(u, mask);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int8_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  static const __m128i mask = _mm_set1_epi8(tailing_mask(int32_t(8 - Shift)));
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, uint16_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_srli_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int16_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_srai_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, uint32_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_srli_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int32_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_srai_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, uint64_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm_srli_epi64(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int64_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  #ifdef HAS_AVX512DQ
...
TLV_INLINE V bit_shr(V v, int shift) {
  CT_ASSERT(0 <= shift && shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range: %d", shift);
...
#if VEC_WIDTH >= 256
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, uint8_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int8_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  static const __m256i mask = _mm256_set1_epi8(tailing_mask(int32_t(8 - Shift)));
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, uint16_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_srli_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int16_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_srai_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, uint32_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_srli_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int32_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_srai_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, uint64_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm256_srli_epi64(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int64_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  #ifdef HAS_AVX512DQ
...
#if VEC_WIDTH >= 512
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, uint8_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int8_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  static const __m512i mask = _mm512_set1_epi8(tailing_mask(int32_t(8 - Shift)));
...
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, uint16_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_srli_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int16_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_srai_epi16(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, uint32_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_srli_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int32_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_srai_epi32(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, uint64_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
  return _mm512_srli_epi64(v.v, Shift);
}
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int64_t>)>
TLV_INLINE V bit_shr(V v) {
  static_assert(0 <= Shift && Shift <= sizeof(TypeOf<T>) * CHAR_BIT, "Shift out of range");
...
#ifdef HAS_AVX512DQ
template <int Shift, TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_any<TypeOf<T>, int8_t, uint8_t, int16_t, uint16_t>)>
TLV_INLINE V bit_shr(V v, Mask<T> m) {
  return word::blend(v, m, word::bit_shr<Shift>(v));
}
template <TLV_DECL_VEC(V), typename T = Vec2Tag<V>, TL_IF(is_any<TypeOf<T>, int8_t, uint8_t, int16_t, uint16_t>)>
TLV_INLINE V bit_shr(V v, int shift, Mask<T> m) {
