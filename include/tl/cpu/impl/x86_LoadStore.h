...
#ifdef HAS_AVX512DQ
template <typename T>
CT_ALWAYS_FORCEINLINE Mask<T> restrict_mask_range(T t, Mask<T> m) {
...
template <typename T, TL_IF(T::Bytes == 8), TL_IF(is_any<TypeOf<T>, float64_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
...
template <typename T, TL_IF(T::Bytes == 4), TL_IF(is_any<TypeOf<T>, float32_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
  return _mm_load_ss(p);
}
template <typename T, TL_IF(T::Bytes == 8), TL_IF(is_any<TypeOf<T>, float32_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
  Tag<float64_t, 1> t1;
...
template <typename T, TL_IF(T::Bytes == 1), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
  return _mm_cvtsi32_si128((int32_t)((const uint8_t *) p)[0]);
}
template <typename T, TL_IF(T::Bytes == 2), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
  return _mm_cvtsi32_si128((int32_t)((const uint16_t *) p)[0]);
}
template <typename T, TL_IF(T::Bytes == 4), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
  return _mm_cvtsi32_si128(((const int32_t *) p)[0]);
}
template <typename T, TL_IF(T::Bytes == 8), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
  return _mm_cvtsi64_si128(((const int64_t *) p)[0]);
}
template <typename T, TL_IF(T::Bytes == 16), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
...
template <typename T, TL_IF(T::Bytes == 16), TL_IF(is_any<TypeOf<T>, float64_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> load(T t, const TypeOf<T> * p) {
...
template <typename T, TL_IF(T::Bytes == 32), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
...
template <typename T, TL_IF(T::Bytes == 64), TL_IF(is_int<TypeOf<T>> || is_small_float<TypeOf<T>>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p) {
...
#ifdef HAS_AVX512DQ
template <typename T, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, float32_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p, Mask<T> m, Vec<T> default_v) {
...
template <typename T, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t, float16_t, bfloat16_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p, Mask<T> m, Vec<T> default_v) {
...
template <typename T, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t, float16_t, bfloat16_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p, Mask<T> m, Vec<T> default_v) {
...
template <typename T, TL_IF(T::Bytes == 64), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t, float16_t, bfloat16_t>)>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p, Mask<T> m, Vec<T> default_v) {
...
template <typename T>
CT_ALWAYS_FORCEINLINE Vec<T> load(T t, const TypeOf<T> * p, Mask<T> m, Vec<T> default_v) {
  CT_ASSERT(is_aligned(T::Bytes, p), "Not aligned");
  return word::loadu(t, p, m, default_v);
}

template <typename T>
CT_ALWAYS_FORCEINLINE Vec<T> loadu(T t, const TypeOf<T> * p, nint_t n, Vec<T> default_v) {
...
template <typename T>
CT_ALWAYS_FORCEINLINE Vec<T> load(T t, const TypeOf<T> * p, nint_t n, Vec<T> default_v) {
  CT_ASSERT(is_aligned(T::Bytes, p), "Not aligned");
...
/* ************************************************************************** */
template <typename T, TL_IF(T::Bytes == 8), TL_IF(is_any<TypeOf<T>, float64_t>)>
CT_ALWAYS_FORCEINLINE void storeu(T t, TypeOf<T> * p, Vec<T> v) {
  _mm_store_sd(p, v.v);
}
template <typename T, TL_IF(T::Bytes == 16), TL_IF(is_any<TypeOf<T>, float64_t>)>
CT_ALWAYS_FORCEINLINE void storeu(T t, TypeOf<T> * p, Vec<T> v) {
...
template <typename T, TL_IF(T::Bytes < 16)>
CT_ALWAYS_FORCEINLINE void store(T t, TypeOf<T> * p, Vec<T> v) {
  CT_ASSERT(is_aligned(T::Bytes, p), "Not aligned");
  word::storeu(t, p, v);
}
template <typename T, TL_IF(T::Bytes == 16), TL_IF(is_any<TypeOf<T>, float32_t>)>
...
#ifdef HAS_AVX512DQ
template <typename T, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, float32_t>)>
CT_ALWAYS_FORCEINLINE void storeu(T t, TypeOf<T> * p, Mask<T> m, Vec<T> v) {
...
template <typename T, TL_IF(T::Bytes < 16)>
CT_ALWAYS_FORCEINLINE void store(T t, TypeOf<T> * p, Mask<T> m, Vec<T> v) {
  CT_ASSERT(is_aligned(T::Bytes, p), "Not aligned");
  word::storeu(t, p, m, v);
}
...
template <typename T, TL_IF(sizeof(TypeOf<T>) < 4)>
CT_ALWAYS_FORCEINLINE void store(T t, TypeOf<T> * p, Mask<T> m, Vec<T> v) {
  CT_ASSERT(is_aligned(T::Bytes, p), "Not aligned");
  word::storeu(t, p, m, v);
}
...
template <typename T, TL_IF(T::Bytes <= 16), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t, float16_t, bfloat16_t, int8_t, uint8_t>)>
CT_ALWAYS_FORCEINLINE void storeu(T t, TypeOf<T> * p, Mask<T> m, Vec<T> v) {
...
template <typename T, TL_IF(T::Bytes == 32), TL_IF(is_any<TypeOf<T>, int16_t, uint16_t, float16_t, bfloat16_t, int8_t, uint8_t>)>
CT_ALWAYS_FORCEINLINE void storeu(T t, TypeOf<T> * p, Mask<T> m, Vec<T> v) {
...
template <typename T>
CT_ALWAYS_FORCEINLINE void storeu(T t, TypeOf<T> * p, nint_t n, Vec<T> v) {
  CT_ASSERT(0 <= n && n <= T::N, "%zd !in 0..%zd", n, T::N);
  auto m = word::mwhilelt(t, 0, n);
  word::storeu(t, p, m, v);
}
...
template <typename T>
CT_ALWAYS_FORCEINLINE void store(T t, TypeOf<T> * p, nint_t n, Vec<T> v) {
  CT_ASSERT(0 <= n && n <= T::N, "%zd !in 0..%zd", n, T::N);
  auto m = word::mwhilelt(t, 0, n);
  word::store(t, p, m, v);
}
